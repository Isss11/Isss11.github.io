		...
		<div className="container-fluid work-term-report-text">
			...
			<div>
				...
				<div className="mx-2">
					...
					<h6 className="goals-area p-1 rounded"><strong>Skills: </strong>React, JavaScript, NCR's API Building Tool, Docker, Kubernetes, Jest, Software Architecture, Documentation</h6>
					...
					<p>
						Creating these configuration formats allowed me to learn more about React, analyzing JavaScript code to find out use cases for specific UI configuration properties. Since this work was such a wide-sweeping architectural change, I met with different people across the company, including technical writers, architects, software engineers and team leads in Canada and India to ask for feedback on my work. This work introduced me to software architecture, making high-level decisions that establish new ways to write better code in the future.
					</p>
					<p>
			...
			<div>
				...
				<div>
					<div className="mx-2">
						...
						<p>Given that this was my first co-op term, I wanted to <em>broaden my horizons</em> as much as possible. Developing a variety of programming skills allows me to see what I like and don't like while becoming a more well-rounded software developer.</p>
				...
				<div>
					<div className="mx-2">
						...
						<p>The goals written here are over-arching goals about becoming more productive in the workplace, school, and life in general. I always seek to find new ways to develop myself as a person, learning new skills and devising strategies to improve in qualitative and quantitative ways.</p>

						<h5>Goals</h5>
						<ol className="goals-area rounded m-1 py-1">
							<li className="goals-area">Become more efficient, getting more work done in less time.</li>
							<li className="goals-area">Show initiative to take part in work activities, even if they are outside of my comfort zone.</li>
							<li className="goals-area">Listen and learn from co-workers.</li>
							<li className="goals-area">Be adaptable and flexible with my transition from the back-end team to the UI architecture team.</li>
						</ol>
			...
			<div>
				...
				<p>After gaining experience with front-end and back-end development, I've decided to move back to my old team and work as a Full Stack Developer, primarily focusing on back-end development. I made this choice because I'm more interested in the intricacies of back-end development, and I'm considering a career as a back-end developer in the future. Additionally, since I've gained more experience in front-end technologies in my personal projects, I feel that learning more about back-end technologies such as Kubernetes and Docker will make me a more well-rounded developer.</p>
			</div>
			...
			<div>
				...
				<p>
					I wanted to thank everyone on both teams that I worked on for always being so kind to me and taking time out of their day to help me learn and progress as a software developer at NCR. Specifically, I wanted to shout out Anthony and Aj for mentoring me throughout the semester.
				</p>
			</div>
