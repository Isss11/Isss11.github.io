	...
	return (
		<div className='container-fluid'>
			<div className='p-4 home-header text-white rounded'>
				...
				<p className='container-fluid'>I am a Computer Science student who has a passion for programming, running and economics.
					I enjoy the process of learning and problem-solving, and have established a strong work ethic to achieve my goals.
					I am currently seeking a co-op position for the Summer 2024 semester, so feel free to reach out!
				</p>
			</div>
